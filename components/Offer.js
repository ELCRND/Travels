export const Offer = () => {
  return `
            <div class="bg-[#F3F5F4]">
                <article class="max-w-[1180px] mx-auto py-20 md:px-28 flex flex-col lg:grid grid-rows-1 grid-cols-2 lg:px-0">
                    ...
                    <section >
                        <div class="max-w-[510px] h-[510px] hidden md:block lg:h-full mt-10 mx-auto lg:ml-[auto] bg-[url('./assets/programm_tour.png')] bg-no-repeat bg-contain"></div>
                    </section>
